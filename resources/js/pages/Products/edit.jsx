            ...
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden transition-all duration-300">
                ...
                <div className="bg-gradient-to-r from-indigo-600 via-indigo-700 to-violet-700 px-8 py-6 text-white flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-indigo-100 text-xs mt-1 font-medium">
                            Update details for <span className="underline font-semibold">{product?.name}</span>
                        </p>
                    </div>
                    <Link
                        href="/products"
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1.5">
                                Product Image <span className="text-slate-400 font-normal normal-case">(Upload new image to replace current)</span>
                            </label>
                            ...
                            {!preview ? (
                                ...
                                <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between gap-4">
                                        ...
                                        <div className="min-w-0">
                                            <div className="flex items-center gap-2">
                                                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-indigo-100 text-indigo-700">
                                                    {fileDetails ? "✓ New File Selected" : "Current Image"}
                                                </span>
                                            </div>
                                            <p className="text-xs font-semibold text-slate-800 mt-1 truncate">
                                                {fileDetails ? fileDetails.name : product?.name}
                                            </p>
                                            {fileDetails && (
                                    ...
                                    <div className="flex items-center gap-2 shrink-0">
                                        <label className="text-xs font-semibold text-indigo-600 hover:text-indigo-700 px-3 py-1.5 rounded-lg hover:bg-indigo-50 transition-colors cursor-pointer">
                                            Change Image
                                            <input
                                                type="file"
                                                accept="image/*"
